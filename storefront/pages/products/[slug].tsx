...
import {
    getProductDetailWithBaseApiUrl,
    getProductOptionValuesWithBaseApiUrl,
    getProductVariationsByParentIdWithBaseApiUrl,
...
export const getServerSideProps: GetServerSideProps = async (
    ...
    const baseApiUrl = "http://storefront.yas.local.com";
    // fetch product by slug
    const product = await getProductDetailWithBaseApiUrl(baseApiUrl, slug as string);
    ...
    if (product.hasOptions) {
        ...
        try {
            const productOptionValue = await getProductOptionValuesWithBaseApiUrl(baseApiUrl, product.id);
        ...
        try {
            productVariations = await getProductVariationsByParentIdWithBaseApiUrl(baseApiUrl, product.id);
        } catch (error) {
            console.error(error);
        }
    }
